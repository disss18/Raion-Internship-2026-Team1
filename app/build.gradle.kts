...
android {
    ...
    defaultConfig {
        ...
        // Mengambil key dari local.properties (Punya Yudis)
...
dependencies {
    ...
    // Supabase & Ktor (Pakai versi 2.5.4 dari Yudis karena lebih stabil)
    ...
    implementation("io.github.jan-tennert.supabase:storage-kt:2.5.4") // Tambahan kamu
